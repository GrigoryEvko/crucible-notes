...
[op-roster.md](op-roster.md) catalogues the operations these verifiers run against. [types-and-attrs.md](types-and-attrs.md) describes the underlying tile, view, pointer, and token types and their structural contracts. [canonicalizers-and-folds.md](canonicalizers-and-folds.md) describes the rewrites that run after verification succeeds. The `nv_tileaa` verifier set in [../nv_tileaa/types-attrs-verifiers.md](../nv_tileaa/types-attrs-verifiers.md) reuses the assumption-predicate contract documented here.
