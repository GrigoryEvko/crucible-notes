...
- [Attention / Native-Kernel Lowering](native-kernel-lowering.md) — §4.32; the attention-fusion path that consumes the same custom-call raising machinery and shares the `getNoComputeOpChain` matchers
