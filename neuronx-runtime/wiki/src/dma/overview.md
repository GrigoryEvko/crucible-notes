...
| [Virtual Rings (vring) and Packet Builders](virtual-rings.md) | the host-side paged descriptor list; the next-desc allocator; the copy/event/CCE/transpose builders; post-hoc pack/barrier/rewrite edits; the dump to pring | dynamic | `vring.c`; `vring_add_desc_transfer 0x3112f0`, `vring_dump_to_pring_descriptors_padded 0x311f10` |
