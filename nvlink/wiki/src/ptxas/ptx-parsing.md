...
**Address distribution.** Hash handlers cluster in the `0x1490000`--`0x1520000` range (92% of entries), while named handlers dominate `0x1520000`--`0x1580000`. This reflects a compilation unit boundary: the hash handlers are likely generated from table-driven templates, while the named handlers are handwritten for semantically complex instructions.
...
| Category | Prefix Pattern | Approx. Count | SM Range |
|---|---|---|---|
