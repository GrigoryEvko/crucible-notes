...
|---|---|---|---|---|
| `get_` | 7 | Provider query + image fetch | `get_api_level`@`0xaec0` (→3) · `get_build_version`@`0xaed0` · `get_git_version`@`0xaee0` · `get_ext_isa`@`0x87a0` · `get_num_ext_isa_libs`@`0x87b0` · `get_memory_image`@`0x8490` · `get_hwdecode_table`@`0x87f0` | 5 of 7 (not hwdecode) |
...
| `core_` | 22 | Per-core bringup, logs, DGE, pc-bounds | `core_create`@`0x99e0` · `core_destroy`@`0x9b20` · `on_ucode_booted`@`0x9e50` (claim) · `enable_logs`@`0x9f60` · `print_logs`@`0xa1a0` · `dge_set_priority_class_map`@`0xa3a0` · `enable_pc_bounds_check`@`0xa860` | 14 of 22 |
| `ll_` | 9 | Low-level loader / device push stream | `ll_create`@`0x8ef0` (prelink) · `ll_destroy`@`0x91e0` · `get_libraries_from_opcodes`@`0x8ce0` · `get_load_sequence`@`0x93f0` · `get_unload_sequence`@`0x9880` · `get_library_size`@`0x98e0` | 7 of 9 |
