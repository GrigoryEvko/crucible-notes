...
A 745 MiB object with **884,832** IDA functions (the function-record count; artifact coverage spans 884,843 entries — see [Overview](overview.md)) cannot be decompiled in one pass — IDA caps and decompiler limits force a windowed strategy. The object was made navigable two ways:
