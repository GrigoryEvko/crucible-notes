...
| **Arch-ops vtable** | `tdrv_arch_ops` `@0xc97180` (.bss, 488 B / 61 physical 8-byte slots (47 named members)) |
...
> **CORRECTION —** the slot count is standardized on [tdrv-arch-ops](tdrv-arch-ops.md): the table is **488 B / 61 physical 8-byte slots (47 named members)** (gap `0xc97368-0xc97180 = 0x1e8 = 488 = 61` slots). The "47 slots" phrasing undercounts the physical layout by 14 — the 47 figure is the count of *named* members, not slots.
