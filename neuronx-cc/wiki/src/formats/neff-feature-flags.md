...
- [Part 12.3 — NEFF JSON Sidecars](neff-json-sidecars.md): the `def.json` that carries the mirror `"neff_features"` name array (and the adjacent `runtime_*` resource keys).
