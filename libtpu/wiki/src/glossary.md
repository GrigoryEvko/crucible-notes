...
| **`gfc` / `6acc60406` / Trillium** | `gxc` family, fetch sub-core `gxc::gfc` (126,696 hits). `TpuVersion` 5, `DeviceType` 12, display string "TPU7x". The chip's only *internal* name in the binary is the obfuscated tag `6acc60406`; "Trillium"/"Ghostfish" are **not in the binary** (external names). |
