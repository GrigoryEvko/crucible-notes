...
- The 6.7.2+ kernels — [flash-attention](nkilib-flash-attention.md), MoE, RMSNorm, RoPE — all build on the allocator / tiling / view primitives documented here.
