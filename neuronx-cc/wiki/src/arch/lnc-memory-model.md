...
- [1.13 GPSIMD Engine](gpsimd-engine.md) — `InstGPSIMDSB2SB`, the one on-chip cross-core copy, its `arch+0x1A4 == 2` gate, and why it is a peer-to-peer move, not a shared address space.
