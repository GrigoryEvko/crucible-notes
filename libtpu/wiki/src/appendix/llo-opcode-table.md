...
|---|---|---:|---|
| Sequencer / sync / FIFO transfer | `0x000`..`0x030` (interleaved) | ~50 | [Sequencer Slot](../isa/slot-sequencer.md) · [Seq-Ops-Per-Gen](../isa/sequencer-ops-per-gen.md) |
| SPU / scalar ALU & control | `0x085`..`0x089`, `0x16B`..`0x1AA` | 63 | [SPU / Scalar Slot](../isa/slot-spu-scalar.md) |
| VPU / vector ALU & logic | `0x048`..`0x05A`, `0x11B`..`0x1A2` | (subset of 295 vector) | [VPU Slot](../isa/slot-vpu.md) |
| Convert / pack / unpack | `0x05B`..`0x076`, `0x107`..`0x11A`, `0x125`..`0x127` | ~45 | [VPU Slot](../isa/slot-vpu.md) · [EUP](../isa/slot-eup-transcendental.md) |
| EUP transcendental | `0x128`..`0x14D` | 38 | [EUP / Transcendental Slot](../isa/slot-eup-transcendental.md) |
| Cross-lane / reduce / XLU result | `0x036`..`0x03B`, `0x0F5`..`0x101`, `0x14E`..`0x155` | ~28 | [ResultFifo / ArchRegister](../isa/resultfifo-archregister.md) |
| MXU matmul / latch / matprep / matres | `0x08D`..`0x0AB`, `0x152`..`0x153` | ~33 | [MXU Slot](../isa/slot-mxu.md) · [Matprep/IAR/Latch](../isa/slot-matprep-iar-latch.md) |
| Memory load / store / IAR / RNG | `0x001`..`0x004`, `0x030`..`0x046`, `0x077`..`0x078` | ~30 | [Memory-Load](../isa/slot-memory-load.md) · [Memory-Store](../isa/slot-memory-store.md) · [CMEM-Load](../isa/slot-cmem-load-pf.md) |
| DMA | `0x0B3`..`0x0DA` (contiguous) | 40 | [Sequencer Slot](../isa/slot-sequencer.md) (DMA-issue) |
| Predicate / mask | `0x0E1`..`0x0F1`, `0x167`..`0x16A`, `0x193`..`0x199` | ~18 | [Predicate Slot](../isa/slot-predicate.md) · [vcreate_mask](../isa/slot-vcreate-mask-mregister.md) |
| Constants / pseudo / call | `0x02C`..`0x02E`, `0x0DB`..`0x0F4`, `0x17C` | ~25 | [Immediate Slot](../isa/slot-immediate.md) |
| BarnaCore (SparseCore) | `0x1AC`..`0x1CC` (contiguous) | 33 | [LLO Opcode Enum](../isa/llo-opcode-enum.md) |
| Sparsity (v5+) structured-sparse | — | (open) | [Sparsity Slot (v5+)](../isa/slot-sparsity-v5plus.md) |
