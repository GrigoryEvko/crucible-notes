...
| `0x5AA000`--`0x67F000` | 874 KB | 628 | Intrinsic infrastructure: 608 CUDA intrinsic handlers, MMA/WMMA/tcgen05 tensor core codegen, SM profile tables (sm\_75 through sm\_121), special register init, ELF/DWARF finalization, memory space management | `sub_5D1660` (608 intrinsics, 46 KB), `sub_607DB0` (SM profile hash maps, 14 KB), `sub_6765E0` (arch capability constructor, 54 KB), `sub_612DE0` (version string) |
