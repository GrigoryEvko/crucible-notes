...
- **The 20-class functional taxonomy** — a name-family grouping covering 1348 of the 1356 by prefix (each class size byte-confirmed individually; see [The 20 Classes](#the-20-classes)); each class mapped to its SparseCore engine or LLO/EmitX target.
...
- [tpu → LLO ODS Lowering](tpu-to-llo-ods.md) — the *other* surface: the 86-op `tpu` dialect lowered to the 322 `llo.*Op` classes; the ODS-from-`create` recovery rule this page reuses
