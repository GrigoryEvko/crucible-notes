...
| Address | Identity |
|---|---|
| `sub_35B1110` | `PrologEpilogInserter::runOnMachineFunction` — main entry (68 KB) |
| `sub_35AC440` | PEI pre-setup: initialize frame object tracking |
| `sub_35AFAD0` | Record frame object into chunk table |
| `sub_35AEEB0` | Determine CSR frame index range (writes PEI+208, +212) |
| `sub_35AE230` | Post-save fixup |
| `sub_35ADBC0` | Insert restore instructions at epilog points |
| `sub_35B0830` | Assign offsets to categorized frame object bucket |
| `sub_35B0B10` | Push frame object index into categorized bucket |
| `sub_35AC7B0` | Post-prolog/epilog fixup |
| `sub_35ABF20` | Try to eliminate a single frame index operand |
| `sub_35C5BD0` | Initialize register scavenger for a MBB |
| `sub_35C5C00` | Advance register scavenger |
| `sub_35C6D20` | Post-scavenging callee-save cleanup |
| `sub_35AE7D0` | Format stack-size annotation |
| `sub_2158E80` | PTX emitter: `emitFunctionFrameSetup()` (__local_depot + %SP/%SPL) |
| `sub_214C040` | Local depot helper |
| `sub_2154370` | Local depot helper |
| `sub_2E77EA0` | Collect callee-saved registers |
| `sub_2FF6500` | Get register class for physical register |
| `sub_2F26260` | Build sub-register decomposition list |
| `sub_2E8EAD0` | Insert compound save instruction |
| `sub_B2D610` | Check optimization level flag |
